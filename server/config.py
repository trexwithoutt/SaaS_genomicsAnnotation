...
class Config(object):  
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = "arn:aws:sns:us-east-1:127134666975:rzhou12_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = "arn:aws:sns:us-east-1:127134666975:rzhou12_job_results"
  AWS_SNS_JOB_GLACIER_TOPIC = "arn:aws:sns:us-east-1:127134666975:rzhou12_job_glacier"
  AWS_SNS_JOB_RETRIEVAL_TOPIC = "arn:aws:sns:us-east-1:127134666975:rzhou12_job_retrieval"

  # Name
  AWS_RETRIEVAL_NAME = "rzhou12_job_retrieval"
  AWS_RESULTS_NAME = "rzhou12_job_results"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "rzhou12_annotations"

  # Stripe API keys
  STRIPE_PUBLIC_KEY = "pk_test_FouSpnn1zj4PoNxH2AZ4xTcA"
  STRIPE_SECRET_KEY = "sk_test_aQKcBLwTcMsyt1zZBMsPqUPc"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "rzhou12@ucmpcs.org"
